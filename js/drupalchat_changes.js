...
function drupalchatMain() {
  ...
  jQuery(document).ready(function(){
    ...
    jQuery('#drupalchat-chat-options-s').live('click', function(e) {
  	...
  	jQuery('#drupalchat-chat-options-o').live('click', function(e) {
     
      jQuery('#drupalchat-wrapper #drupalchat').hide();
      jQuery('#drupalchat-wrapper #drupal_offline').show();
      jQuery('#drupalchat-chat-options').hide();
      jQuery.post(Drupal.settings.drupalchat.statusUrl, {status: "3"}, function(data){
    ...
    jQuery('#drupal_offline #online').live('click', function(e) {
  	 
      jQuery('#drupalchat-wrapper #drupalchat').show();
  	  jQuery('#drupalchat-wrapper #drupal_offline').hide();
  ...
  //	    e.stopPropagation(); //Prevents the subpanel ul from closing on click
  	...
  	if (Drupal.settings.drupalchat.status == 1) {
          //  console.log("1");
              jQuery(".chat_options .chat_loading").removeClass('chat_loading').addClass('status-2').html(Drupal.settings.drupalchat.goIdle);
              jQuery("#chatpanel .icon").attr("src", Drupal.settings.drupalchat.images + "chat-1.png");
               jQuery('#image_chat i.fa').removeClass('idle');
               jQuery('#image_chat i.fa').removeClass('offline');
  	}
           ...
           // console.log("2");
              ...
              jQuery("#chatpanel .icon").attr("src", Drupal.settings.drupalchat.images + "idle.png");
              jQuery('#image_chat i.fa').addClass('idle');
  	}
  	...
  	jQuery(".chat_options .status-2").live('click', function() {
        ...
        jQuery('#drupalchat-chat-options-o').click(function() {
           // console.log("3");
            if(jQuery('#image_chat i.fa').hasClass('idle')) {
                jQuery('#image_chat i.fa').removeClass('idle');
            }
            jQuery('#image_chat i.fa').addClass('offline');
        });
        jQuery('#drupalchat-wrapper #drupal_offline #online').click(function() {
            //console.log("4");
            //jQuery('#image_chat i.fa').removeClass('idle');
            jQuery('#image_chat i.fa').removeClass('offline');
        });
  ...
  function createChatBox(chatboxtitle, chatboxname, chatboxblink) {
      ...
      .addClass("chatbox")
      .html('<a href="#" class="chatboxhead"><span class="subpanel_title_text">'+chatboxname+'</span></a><div class="subpanel"><div class="subpanel_title"><span class="'+chatboxtitle+'" title="Close">x</span><span title = "Minimize" class="min">_</span><div class="status-1"></div>'+chatboxname+'</div><div class="chatboxcontent"></div><div class="drupalchat_userOffline">'+chatboxname+' est actuellement d&eacute;connect&eacute;.</div><div class="chatboxinput"><textarea class="chatboxtextarea" onkeydown="return Drupal.drupalchat.checkChatBoxInputKey(event,this,\''+chatboxtitle+'\');"></textarea></div></div>')
